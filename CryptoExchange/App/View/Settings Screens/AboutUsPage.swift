...
struct AboutUsPage: View {
    ...
    let aboutUsTitle = SettingsScreensTitle(
        settingsScreensTitle: "About Us"
    )
    ...
    let whoAreWeTitle = SettingsScreensTitle(
        settingsScreensTitle: "Who We Are?"
    )
    ...
    let whatWeDoTitle = SettingsScreensTitle(
        settingsScreensTitle: "What We Do?"
    )
            ...
            ScrollView(showsIndicators: false) {
                VStack {
                    ...
                    SettingsScreensView(
                        viewModelTitle:
                            SettingsScreensViewModel.SettingsScreensTitleViewModel(
                            settingsScreensTitle: whoAreWeTitle
                        ),
                        viewModelDescription:
                            SettingsScreensViewModel.SettingsScreensDescriptionViewModel(
                            settingsScreensDescription: whoAreWeDescription
                        )
                    )
                    ...
                    SettingsScreensView(
                        viewModelTitle:
                            SettingsScreensViewModel.SettingsScreensTitleViewModel(
                            settingsScreensTitle: whatWeDoTitle
                        ),
                        viewModelDescription:
                            SettingsScreensViewModel.SettingsScreensDescriptionViewModel(
                            settingsScreensDescription: whatWeDoDescription
                        )
                    )
