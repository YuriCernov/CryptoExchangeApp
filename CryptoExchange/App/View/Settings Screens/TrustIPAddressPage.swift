...
struct TrustIPAddressPage: View {
    ...
    let trustIPAddressTitle = SettingsScreensTitle(
        settingsScreensTitle: "Trust IP Address"
    )
            ...
            VStack {
                ...
                SettingsScreensView(
                    viewModelTitle: SettingsScreensViewModel.SettingsScreensTitleViewModel(
                        settingsScreensTitle: trustIPAddressTitle
                    ),
                    viewModelDescription: SettingsScreensViewModel.SettingsScreensDescriptionViewModel(
                        settingsScreensDescription: trustIPAddressDescription
                    )
                )
