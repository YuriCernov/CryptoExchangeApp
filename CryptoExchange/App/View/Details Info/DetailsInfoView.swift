    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            HStack(alignment: .center) {
                ...
                Spacer()
                LimitsLine(widthFill: 43, widthEmpty: 55, foregroundColorFill: DarkThemeMainYellowColor)
            }
            HStack(alignment: .center) {
                HStack(spacing: 13) {
                ...
                Spacer()
                LimitsLine(widthFill: 81, widthEmpty: 16, foregroundColorFill: DarkThemeMainRedColor)
            }
            ...
            HStack(spacing: 11) {
                GraphicPrices(
                    title: "Last Price:", titleForegroundColor: DarkThemeSecondTextColor,
                    value: "1110", valueForegroundColor: DarkThemeStandartTextColor,
                    additionalValue: ".23 USD", additionalValueForegroundColor: DarkThemeSecondTextColor
                )
                HStack(spacing: 34) {
                    GraphicPrices(
                        title: "Low:", titleForegroundColor: DarkThemeSecondTextColor,
                        value: "853", valueForegroundColor: DarkThemeStandartTextColor,
                        additionalValue: ".11 USD", additionalValueForegroundColor: DarkThemeSecondTextColor
                    )
                    GraphicPrices(
                        title: "High:", titleForegroundColor: DarkThemeMainGreenColor,
                        value: "1495", valueForegroundColor: DarkThemeMainGreenColor,
                        additionalValue: ".86 USD", additionalValueForegroundColor: DarkThemeMainGreenColor
                    )
                }
            }
...
struct CryptoAddButton: View {
    ...
    let addButtonIM = CryptoButtonsImage(cryptoButtonsImage: "plus")
    let addButtonFC = CryptoButtonsForegroundColor(cryptoButtonsForegroundColor: DarkThemeMainWhiteColor)
    let addButtonBC = CryptoButtonsBackgroundColor(cryptoButtonsBackgroundColor: DarkThemeMainLightColor)
    let addButtonFW = CryptoButtonsFontWeight(cryptoButtonsFontWeight: .light)
    
    var body: some View {
        Button { isCryptoAddScreenPresented = true }
        label: {
            CryptoButtonsView(
                viewModelIM: CryptoButtonsViewModel.CryptoButtonsImageViewModel(cryptoButtonImage: addButtonIM),
                viewModelFC: CryptoButtonsViewModel.CryptoButtonsForegroundColorViewModel(cryptoButtonForegroundColor: addButtonFC),
                viewModelBG: CryptoButtonsViewModel.CryptoButtonsBackgroundColorViewModel(cryptoButtonBackgroundColor: addButtonBC),
                viewModelFW: CryptoButtonsViewModel.CryptoButtonsFontWeightViewModel(cryptoButtonFontWeight: addButtonFW)
